      ...
      <div className="container max-w-6xl mx-auto">
        ...
        <div className="grid lg:grid-cols-2 gap-10 items-center">
            ...
            <div className="bg-card rounded-2xl shadow-elevated p-6">
              <div className="space-y-4">
                ...
                <div className="flex items-start gap-3 justify-end">
                  <div className="bg-foreground rounded-xl px-4 py-3 max-w-xs">
                    <p className="text-sm text-background">
                      Hi Sarah! I checked your account. Your bill increased because you upgraded to the Pro plan on March 1st.
                    </p>
                ...
                <div className="flex items-start gap-3 justify-end">
                  <div className="bg-foreground rounded-xl px-4 py-3 max-w-xs">
                    <p className="text-sm text-background">
                      Let me connect you with our billing team. Creating a ticket now.
                    </p>
          ...
          <div className="space-y-6">
            {benefits.map((b, i) => (
              <ScrollReveal key={b.title} delay={i * 0.1} direction="right">
